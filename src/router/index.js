    ...
    children: [
      {
        path: 'users',
        name: 'admin-users',
        component: () => import('../components/AdminUserList')
      },
      {
        path: 'posts',
        name: 'admin-posts',
        component: () => import('../components/AdminPostList')
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('../components/PostBlockShort')
      },
      {
        path: 'replies',
        name: 'personal-page-replies',
        component: () => import('../components/ReplyBlock')
      },
      {
        path: 'liked',
    ...
    children: [
      {
        ...
        component: () => import('../components/FollowUsers')
      },
      {
        path: 'followings',
